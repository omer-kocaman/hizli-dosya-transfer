...
4\. `index.html` dosyasını tarayıcınızda açarak kullanmaya başlayın! \*(Kurulumla uğraşmak istemiyorsanız doğrudan https://hizlidosyapaylasimi.netlify.app adresini ziyaret ederek sistemi test edebilirsiniz).\*
